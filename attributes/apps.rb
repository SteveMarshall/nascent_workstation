...
node.default["adium"]["checksum"]="c11302c03c90bffeafb25b36a0a77c97fc27f32f2c32845df2292416b46457aa"
node.default["adium"]["destination"]="#{ENV['HOME']}/Applications"

node.default["dropbox"]["source"]="https://www.dropbox.com/download?plat=mac"
node.default["dropbox"]["checksum"]="d74666cdb67ac7c82aedfaf8654bfc77c65fc9596d2a346ab08ec5c5cb4f735a"
...
# node.override[:safari][:color]="graphite"